...
<#
.SYNOPSIS
Crée et déploie un site Web Windows Azure pour un projet Web Visual Studio.
...
try
{
    ...
    {
         throw 'Vous avez une version obsolète de Windows Azure PowerShell. Pour installer la dernière version, accédez à http://go.microsoft.com/fwlink/?LinkID=320552.'
    }
